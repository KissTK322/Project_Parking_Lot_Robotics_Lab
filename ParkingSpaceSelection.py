...
def mouseClick(event, x, y, flags, params):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        if len(polygon_points) == 4:
            ...
            with open(r'/Users/np/Documents/Project_Parking_Lot_Robotics_Lab/Space_ROIs', 'wb') as f:
...
while True:
    img = cv2.imread(r"/Users/np/Documents/Project_Parking_Lot_Robotics_Lab/ROI_Reference.png")
